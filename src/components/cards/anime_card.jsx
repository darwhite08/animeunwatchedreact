                ...
                <div className="content">
                    <div className="back">
                        <div className="back-content relative ">
                            <img className='h-72' src="/assets/background/animeListBackground.jpg" alt="" />
                            <div className='absolute top-2 flex flex-row justify-between w-full px-4'>
                                <p className='bg-red-300 text-red-600 rounded-lg px-2 py-1 text-xs font-medium'>new</p>
                            </div>
                            <div className='absolute bottom-2 px-2'>
                                <p className='px-2 py-2 rounded-lg inline flex item-center justify-center bg-black/30 backdrop-blur-lg text-white font-bold text-xs'>The emminence in shadow</p>
                            </div>
                        </div>
                    </div>
                    <div className="front">

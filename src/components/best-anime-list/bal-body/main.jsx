...
import BalFeedCard from "../Bal_feed/bal_feed_card";
        ...
        <StyledWrapper>
            <div className="">
                <div className=" static flex flex-row justify-between gap-4">
                    {/* Best anime list feed */}
                    <div className="basis-3/4 px-10">
                    <BalFeedCard/>
                    </div>
                    {/* Best Anime list Reccomendation And ad */}
                    <div className="scrollbar sticky top-0 max-h-screen overflow-y-scroll left-0 bg-gray-100 py-2 px-10 -mr-10">
